...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.7]{8slavecpu.jpg}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.8]{8slavedisk.JPG}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.7]{8slavememory.JPG}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.7]{8slavenet.JPG}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.7]{16slavecpu.jpg}
    \caption{L'uso del processore da parte di ogni slave}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.7]{16slavedisk.jpg}
    \caption{Le operazioni sul disco da parte di ogni slave}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.7]{16slavememory.jpg}
    \caption{Lo stato della memoria di ogni slave}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.7]{16slavenet.jpg}
    \caption{Le operazioni sulla rete compiute da ogni slave}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.8]{24slavecpu.jpg}
    \caption{L'uso del processore da parte di ogni slave}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.7]{24slavedisk.JPG}
    \caption{Le operazioni sul disco da parte di ogni slave}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.7]{24slavememory.JPG}
    \caption{Lo stato della memoria di ogni slave}
    \label{fig:8slavememory.JPG}
  \end{center}
\end{figure}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.7]{24slavenet.JPG}
    \caption{Le operazioni sulla rete compiute da ogni slave}
    \label{fig:8slavenet.JPG}
  \end{center}
\end{figure}